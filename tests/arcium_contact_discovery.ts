...
import { ArciumContactDiscovery } from "../target/types/arcium_contact_discovery";
...
describe("ArciumContactDiscovery", () => {
  // Configure the client to use the local cluster.
  anchor.setProvider(anchor.AnchorProvider.env());
  const program = anchor.workspace
    .ArciumContactDiscovery as Program<ArciumContactDiscovery>;
  ...
  async function initAddTogetherCompDef(
    program: Program<ArciumContactDiscovery>,
